export function AtomSvg() {
  return (
    <svg viewBox="0 0 360 360" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <text x="32" y="262" fontFamily="var(--font-mono)" fontSize="9" fill="rgba(1,156,255,0.28)" letterSpacing="1">ALCHM</text>
      <text x="268" y="62" fontFamily="var(--font-mono)" fontSize="9" fill="rgba(254,84,1,0.3)" letterSpacing="1">SEO</text>
    </svg>
  );
}
